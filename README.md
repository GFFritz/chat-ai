Este é um projeto desenvolvido em [Next.js](https://nextjs.org/), Utilizando [TailwindCSS](https://tailwindcss.com/), [Vercel AI SDK](https://sdk.vercel.ai/) e [OpenAI](https://platform.openai.com) GPT 3.5-turbo.
